...
{
public:
    static std::tuple<int, std::string, std::string> GetInputParameters(int argc, ARGV& argv);
private:
    ...
    static std::tuple<std::string, std::string> separateCommandAndParams(std::optional<std::string> cmd);
};
